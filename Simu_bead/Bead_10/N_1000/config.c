...
Config parse_config(int argc, char *argv[])
{
    ...
    if (argc < 5)
    {
        fprintf(stderr, "Usage : %s nb_rnap vitesse_rnap alpha seed\n", argv[0]); // Vérification du bon nombre d'arguments
        exit(1);
    }
    ...
    // cfg.T_eq = 0;
    // cfg.T = 1e6; 
    // cfg.periode_enregistrement = 1e3;
    // cfg.periode_msd = 10000;
    // cfg.periode_correlation = 10;
    // cfg.periode_endtoend = 10;
